...
<x-app-layout>
    @php
        ...
        $primaryRoleLabel = ucwords(str_replace(['-', '_'], ' ', (string) $primaryRole));
    ...
    <x-slot name="header">
        <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div>
                <p class="text-xs font-extrabold uppercase tracking-[0.22em] text-[#2E3192]/70">Admin Profile</p>
                <h2 class="mt-1 text-2xl font-black leading-tight text-slate-950">Edit user profile</h2>
            </div>
            <div class="flex flex-wrap items-center gap-2">
                @if($publicLink)
                    <a href="{{ $publicLink }}" target="_blank" rel="noreferrer" class="inline-flex min-h-11 items-center justify-center gap-2 rounded-lg border border-[#2E3192]/20 bg-white px-4 py-2 text-sm font-extrabold text-[#2E3192] shadow-sm transition hover:border-[#2E3192]/40 hover:bg-[#2E3192]/5">
                        <i class="fa-solid fa-arrow-up-right-from-square text-xs"></i>
                        Public profile
                    </a>
                @endif
                <a href="/users" class="inline-flex min-h-11 items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm font-extrabold text-slate-700 shadow-sm transition hover:border-[#2E3192]/30 hover:bg-[#2E3192]/5 hover:text-[#2E3192]">
            ...
            <div class="bg-[#17194f] px-5 py-6 text-white sm:px-7">
                <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
                    <div class="flex min-w-0 items-center gap-4">
                        ...
                        <div class="min-w-0">
                            <div class="flex flex-wrap items-center gap-2">
                                ...
                                <span class="rounded-full bg-white/10 px-3 py-1 text-xs font-extrabold uppercase tracking-wide text-white/90 ring-1 ring-white/10">{{ $primaryRoleLabel }}</span>
                            </div>
                    ...
                    <div class="w-full max-w-sm rounded-lg bg-white/10 p-4 ring-1 ring-white/10 md:w-72">
                        ...
                        <div class="mt-2 text-xs font-semibold text-white/70">{{ $completedCount }} of {{ count($completionChecks) }} editable items complete</div>
                    </div>
                </div>
            </div>
        </section>
