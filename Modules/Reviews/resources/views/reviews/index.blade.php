<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            @can('addReview')
                <a href="/dashboard/reviews/create" class="inline-flex items-center rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500">
                    Add Review
                </a>
            @endcan
        </div>
